...
})({"4M7Zx":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cc92d1d2a2ef5d5e";
...
},{}],"3cWKW":[function(require,module,exports) {
...
const runGameMode = function() {
    if (runGameBtn) runGameBtn.addEventListener('click', ()=>{
...
const enableDragging = function(board) {
    ...
    boardSquares.forEach((square)=>square.addEventListener('dragover', dragOver)
    );
    boardSquares.forEach((square)=>square.addEventListener('dragenter', dragEnter)
    );
};
if (mode) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./AudioController":"1hpJQ","./utils":"cKgRu","@babel/polyfill":"dTCHC"}],"gkKU3":[function(require,module,exports) {
...
},{}],"1hpJQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _musicResumedSvg = require("./../images/MusicResumed.svg");
var _musicResumedSvgDefault = parcelHelpers.interopDefault(_musicResumedSvg);
var _musicPausedSvg = require("./../images/MusicPaused.svg");
var _musicPausedSvgDefault = parcelHelpers.interopDefault(_musicPausedSvg);
var _audioPlayer = require("./AudioPlayer");
var _audioPlayerDefault = parcelHelpers.interopDefault(_audioPlayer);
class AudioController {
    #musicController;
    #AudioPlayer = new _audioPlayerDefault.default();
    constructor(){
    ...
    control() {
     ...
     #controlMusicHandler() {
        if (!this.#AudioPlayer._isMusicPlaying) {
            ...
            this.#musicController.children[0].src = _musicResumedSvgDefault.default;
            return;
        }
        if (this.#AudioPlayer._isMusicPlaying) {
            this.#AudioPlayer.pause();
            this.#musicController.children[0].src = _musicPausedSvgDefault.default;
        }
    }
}
exports.default = AudioController;

},{"./AudioPlayer":"QCs7J","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./../images/MusicResumed.svg":"9pBDO","./../images/MusicPaused.svg":"knA7i"}],"QCs7J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class AudioPlayer {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9pBDO":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('hyWhq') + "MusicResumed.fdee2d54.svg" + "?" + Date.now();
...
},{}],"knA7i":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('hyWhq') + "MusicPaused.7a3493c5.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"cKgRu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const showModal = ()=>{
    ...
    window.setTimeout(()=>modal.classList.add('modal--hidden')
    , 4000);
...
},{}]},["4M7Zx","3cWKW"], "3cWKW", "parcelRequire2f83")

//# sourceMappingURL=index.a2ef5d5e.js.map
